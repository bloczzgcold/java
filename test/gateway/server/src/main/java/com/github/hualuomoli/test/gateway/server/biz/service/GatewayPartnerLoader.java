package com.github.hualuomoli.test.gateway.server.biz.service;
...
@Service(value = "com.github.hualuomoli.test.gateway.server.biz.service.GatewayPartnerLoader")
...
public class GatewayPartnerLoader implements PartnerLoader {
	...
	public Partner load(String partnerId) {
		...
		com.github.hualuomoli.test.gateway.server.biz.entity.Partner partner = partnerService.findByPartnerId(partnerId);
		if (partner == null) {
			return null;
		}
