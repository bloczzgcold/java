...
import org.springframework.test.web.servlet.util.Utils;
...
public class MockHttpServletRequestBuilder implements RequestBuilder, Mergeable {
	 ...
	 * @param datePattern date pattern
	 */
	private MockHttpServletRequestBuilder addParam(List<Utils.UrlencodedParam> list) {

		if (list == null || list.size() == 0) {
			return this;
		}

		for (Utils.UrlencodedParam urlencodedParam : list) {
